...
def main():
    ...
    parser.add_argument("--top_p", type=float, default=1.0, help="Top-p (nucleus) filtering limit.")
    parser.add_argument("--repetition_penalty", type=float, default=1.0, help="Repetition penalty factor.")
